...
namespace driver {
	...
	NTSTATUS device_control(PDEVICE_OBJECT device_object, PIRP irp) {
		...
		// The target we want to access to.
...
NTSTATUS driver_main(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path) {
	...
	RtlInitUnicodeString(&device_name, L"\\Device\\SDriver");
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\SDriver");
	...
	// Allow us to send small amount of data between um/km.
...
NTSTATUS DriverEntry() {
	debug_print("[+] Hello user from the kernel!\n");

	UNICODE_STRING driver_name = {};
	RtlInitUnicodeString(&driver_name, L"\\Driver\\SDriver");
